...
import {Horizontal, TransposeComponent} from "../app/examples/transpose/transpose.component";
import {Nested, NestedDataComponent} from "../app/examples/nested-data/nested-data.component";

<Meta title="Examples" decorators={[
  moduleMetadata({
    declarations: [CustomTemplatesComponent, SimpleComponent, AdvancedComponent, PaginationComponent, TransposeComponent, TabsComponent, MobileLayoutComponent, NestedDataComponent],
