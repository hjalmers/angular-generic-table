...
var GenericTableComponent = (function () {
    function GenericTableComponent(sanitizer) {
        ...
        this.changeRowLength = function (rowLength, reset) {
            ...
            if (reset !== true && this.gtLazy !== true) {
                ...
                var currentRecord = this.gt.rowLength * (this.gt.currentPage - 1);
        ...
        this.updateTotalPages = function () {
            var rows = this.gt.filtered ? this.gt.filtered : this.gtData.length;
        ...
        this.nextPage = function () {
            var page = this.gt.currentPage === this.gt.pagesTotal ? this.gt.pagesTotal : this.gt.currentPage += 1;
            this.goToPage(page);
        };
        /** Go to previous page. */
        this.previousPage = function () {
            var page = this.gt.currentPage === 1 ? 1 : this.gt.currentPage -= 1;
            this.goToPage(page);
        };
    ...
    GenericTableComponent.prototype.ngAfterViewInit = function () {
        //console.log('view');
    };
    GenericTableComponent.prototype.ngOnChanges = function () {
        ...
        if (this.gtLazy && this.gtPaging) {
            ...
            var storePosition = this.gtPaging.current_page - 1;
